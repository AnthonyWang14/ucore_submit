...
stride_init(struct run_queue *rq) {
    ...
    // rq->lab6_run_pool->left = rq->lab6_run_pool->right = rq->lab6_run_pool->parent = NULL;
    // assert(0);
    rq->proc_num = 0;
}
...
stride_pick_next(struct run_queue *rq) {
    ...
    if (rq->lab6_run_pool == NULL) {
        ...
        // cprintf("pid is %d, stride is 0x%08x\n", proc->pid, proc->lab6_stride);
        // // assert (proc->lab6_priority > 0);
        // if (proc->lab6_priority == 0){
        //     // assert(0);
        //     // proc->lab6_stride += BIG_STRIDE;
        // } else {
        //     cprintf("priority is %d add is 0x%08x\n", proc->lab6_priority, (BIG_STRIDE / proc->lab6_priority));
        // }
        // cprintf("before next is pid %d, stride is %d, priority is %d\n", proc->pid, proc->lab6_stride, proc->lab6_priority);
        assert(proc->lab6_priority > 0);
